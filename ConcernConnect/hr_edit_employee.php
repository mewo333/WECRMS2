            ...
            <div class="profile-grid">
                ...
                <div class="card">
                    <h3>
                        ...
                        <span style="font-size: 12px; color: #94a3b8; font-weight: 500; margin-left: auto;">
                    ...
                    <div class="info-box">
                        ...
                        <div class="read-only-value"><?php echo htmlspecialchars($user['full_name']); ?></div>
                    </div>

                    <div class="info-box">
                        <div class="info-box-label">Email Address</div>
                        <div class="read-only-value"><?php echo htmlspecialchars($user['email']); ?></div>
                    </div>

                    <div class="info-box">
                        <div class="info-box-label">Phone Number</div>
                        <div class="read-only-value"><?php echo htmlspecialchars($user['phone_number'] ?? 'Not provided'); ?></div>
                    </div>

                    <div class="info-box">
                        <div class="info-box-label">Nationality</div>
                        <div class="read-only-value"><?php echo htmlspecialchars($user['nationality'] ?? 'Filipino'); ?></div>
                    </div>

                    <div class="info-box">
                        <div class="info-box-label">Date Joined</div>
                        <div class="read-only-value"><?php echo date('F j, Y', strtotime($user['created_at'])); ?></div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="info-box">
                        ...
                        <div class="read-only-value"><?php echo htmlspecialchars($user['street_address'] ?? 'Not provided'); ?></div>
                    </div>

                    <div class="address-row">
                        <div class="info-box">
                            <div class="info-box-label">Barangay</div>
                            <div class="read-only-value"><?php echo htmlspecialchars($user['barangay'] ?? 'Not provided'); ?></div>
                        </div>

                        <div class="info-box">
                            <div class="info-box-label">City</div>
                            <div class="read-only-value"><?php echo htmlspecialchars($user['city'] ?? 'Not provided'); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="address-row">
                        <div class="info-box">
                            ...
                            <div class="read-only-value"><?php echo htmlspecialchars($user['province'] ?? 'Not provided'); ?></div>
                        </div>

                        <div class="info-box">
                            <div class="info-box-label">Postal Code</div>
                            <div class="read-only-value"><?php echo htmlspecialchars($user['postal_code'] ?? 'Not provided'); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <div class="info-box-display">
                                <p id="department_display" class="info-box-value"><?php echo htmlspecialchars($user['department'] ?? 'Not assigned'); ?></p>
                            </div>
                            <button class="edit-btn" onclick="toggleEdit('department')" type="button">
                                <i class="bi bi-pencil"></i> Edit
                            </button>
                        </div>
                        <div class="info-box-input d-none">
                            <select id="department_input" class="form-control">
                                <option value="">Select Department</option>
                                <option value="Engineering" <?php echo ($user['department'] ?? '') === 'Engineering' ? 'selected' : ''; ?>>Engineering</option>
                                <option value="Data Science" <?php echo ($user['department'] ?? '') === 'Data Science' ? 'selected' : ''; ?>>Data Science</option>
                                <option value="Data Engineering" <?php echo ($user['department'] ?? '') === 'Data Engineering' ? 'selected' : ''; ?>>Data Engineering</option>
                                <option value="DevOps" <?php echo ($user['department'] ?? '') === 'DevOps' ? 'selected' : ''; ?>>DevOps</option>
                                <option value="Quality Assurance" <?php echo ($user['department'] ?? '') === 'Quality Assurance' ? 'selected' : ''; ?>>Quality Assurance</option>
                                <option value="Product Management" <?php echo ($user['department'] ?? '') === 'Product Management' ? 'selected' : ''; ?>>Product Management</option>
                                <option value="Project Management Office" <?php echo ($user['department'] ?? '') === 'Project Management Office' ? 'selected' : ''; ?>>Project Management Office</option>
                                ...
                                <option value="Security & Infrastructure" <?php echo ($user['department'] ?? '') === 'Security & Infrastructure' ? 'selected' : ''; ?>>Security & Infrastructure</option>
                                <option value="Business Intelligence" <?php echo ($user['department'] ?? '') === 'Business Intelligence' ? 'selected' : ''; ?>>Business Intelligence</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <div class="info-box-display">
                                <p id="position_display" class="info-box-value"><?php echo htmlspecialchars($user['position'] ?? 'Not assigned'); ?></p>
                            </div>
                            <button class="edit-btn" onclick="toggleEdit('position')" type="button">
                                <i class="bi bi-pencil"></i> Edit
                            </button>
                        </div>
                        <div class="info-box-input d-none">
                            <input type="text" id="position_input" class="form-control" value="<?php echo htmlspecialchars($user['position'] ?? ''); ?>" placeholder="e.g., Senior Software Engineer">
                        </div>
                    </div>
